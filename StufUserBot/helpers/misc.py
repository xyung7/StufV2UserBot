...
from StufUserBot import LOGGER
...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("StufUserBot").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("StufUserBot").info(f"Invalid Git Command")
        ...
        LOGGER("StufUserBot").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("StufUserBot").info(f"Heroku App Configured")
