...
if ALIVE_IMG:
    ...
    ALIVE_PIC = 'https://telegra.ph/file/8f0122b2d617df1f36457.jpg'
...
if bot1:
    bot1.start()
    bot1.join_chat("stufuserbot")
if bot2:
    bot2.start()
    bot2.join_chat("stufuserbot")
if bot3:
    bot3.start()
    bot3.join_chat("stufuserbot")
if bot4:
    bot4.start()
    bot4.join_chat("stufuserbot")
if bot5:
    bot5.start()
    bot5.join_chat("stufuserbot")
if bot6:
    bot6.start()
    bot6.join_chat("stufuserbot")
if bot7:
    bot7.start()
    bot7.join_chat("stufuserbot")
if bot8:
    bot8.start()
    bot8.join_chat("stufuserbot")
if bot9:
    bot9.start()
    bot9.join_chat("stufuserbot")
if bot:
    bot.start()
    bot.join_chat("stufuserbot")
if bot11:
    bot11.start()
    bot11.join_chat("stufuserbot")
if bot12:
    bot12.start()
    bot12.join_chat("stufuserbot")
if bot13:
    bot13.start()
    bot12.join_chat("stufuserbot")
if bot14:
    bot14.start()
    bot14.join_chat("stufuserbot")
if bot15:
    bot15.start()
    bot15.join_chat("stufuserbot")
if bot16:
    bot16.start()
    bot16.join_chat("stufuserbot")
if bot17:
    bot17.start()
    bot17.join_chat("stufuserbot")
if bot18:
    bot18.start()
    bot18.join_chat("stufuserbot")
if bot19:
    bot19.start()
    bot19.join_chat("stufuserbot")
if bot20:
    bot20.start()
    bot20.join_chat("stufuserbot")
if bot21:
    bot21.start()
    bot21.join_chat("stufuserbot")
if bot22:
    bot22.start()
    bot22.join_chat("stufuserbot")
if bot23:
    bot23.start()
    bot23.join_chat("stufuserbot")
if bot24:
    bot24.start()
    bot24.join_chat("stufuserbot")
if bot25:
    bot25.start()
    bot25.join_chat("stufuserbot")
if bot26:
    bot26.start()
    bot26.join_chat("stufuserbot")
if bot27:
    bot27.start()
    bot27.join_chat("stufuserbot")
if bot28:
    bot28.start()
    bot28.join_chat("stufuserbot")
if bot29:
    bot29.start()
    bot29.join_chat("stufuserbot")
if bot30:
    bot30.start()
    bot30.join_chat("stufuserbot")
if bot31:
    bot31.start()
    bot31.join_chat("stufuserbot")
if bot32:
    bot32.start()
    bot32.join_chat("stufuserbot")
if bot33:
    bot33.start()
    bot33.join_chat("stufuserbot")
if bot34:
    bot34.start()
    bot34.join_chat("stufuserbot")
if bot35:
    bot35.start()
    bot35.join_chat("stufuserbot")
if bot36:
    bot36.start()
    bot36.join_chat("stufuserbot")
if bot37:
    bot37.start()
    bot37.join_chat("stufuserbot")
if bot38:
    bot38.start()
    bot38.join_chat("stufuserbot")
if bot39:
    bot39.start()
    bot39.join_chat("stufuserbot")
if bot40:
    bot40.start()
    bot40.join_chat("stufuserbot")
if bot41:
    bot41.start()
    bot41.join_chat("stufuserbot")
if bot42:
    bot42.start()
    bot42.join_chat("stufuserbot")
if bot43:
    bot43.start()
    bot43.join_chat("stufuserbot")
if bot44:
    bot44.start()
    bot44.join_chat("stufuserbot")
if bot45:
    bot45.start()
    bot45.join_chat("stufuserbot")
if bot46:
    bot46.start()
    bot46.join_chat("stufuserbot")
if bot47:
    bot47.start()
    bot47.join_chat("stufuserbot")
if bot48:
    bot48.start()
    bot48.join_chat("stufuserbot")
if bot49:
    bot49.start()
    bot49.join_chat("stufuserbot")
if bot50:
    bot50.start()
    bot50.join_chat("stufuserbot")

idle()

print("🎉 Successfully Deployed 🎉 @stufuserbot")
print("Enjoy! Do visit @stufchannel")
